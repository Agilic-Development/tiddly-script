...
def main(stdscr):
    ...
    try:
        ...
        while True:
            ...
            if get_10_second(time):  # Every 10th a second
                time += 0.1  # update time keepers
                tenth_seconds += 0.1
                if int(tenth_seconds) == seconds:  # Update Every second
                    seconds += 1
                    ...
                    if seconds % 3 == 0:  # Update every three seconds
                        tri_seconds += 3
            ...
            "Delta: " + str(delta) + "ms",
            "10th Seconds: " + str(tenth_seconds), "Seconds: " + str(seconds), "Tri-seconds: " + str(tri_seconds))
...
def get_10_second(time):
    if (get_time_sec() - time) * 10 >= 1:
        return True
    return False
